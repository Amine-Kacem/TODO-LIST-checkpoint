...
const Todos = () => {
  ...
  const editfun = (elem, id) => {
    ...
    if (content === null) setTodos([...todolist, { id: id, content: elem }]);
    else setTodos([...todolist, { id: id, content: content }]);
  };
          ...
          <div className="buttons">
            <span>
              <button
                className="btn2"
                type="submit"
                onClick={() => editfun(todo.content, todo.id)}
              >
